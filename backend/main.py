...
from routers.friends import available_router as available_friends_router
...
app.add_middleware(
    ...
    allow_headers=["Authorization", "Content-Type", "X-Current-Email", "X-Current-User-Id", "X-Current-Auth-User-Id"],
)
...
app.include_router(available_friends_router)
